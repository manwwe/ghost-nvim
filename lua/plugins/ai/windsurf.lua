...
return {
  {
    ...
    -- Load after nvim-cmp to ensure proper source registration
    event = "InsertEnter",
    config = function()
      require("codeium").setup({
        ...
        -- Ensure cmp source is enabled
        enable_cmp_source = true,

        -- Configure virtual text (optional - can disable if using only cmp)
        virtual_text = {
          enabled = false, -- Use cmp instead
        },
      })
