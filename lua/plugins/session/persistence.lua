...
return {
  ...
  config = function()
    ...
    keymap('n', '<leader>ps', function() require('persistence').load() end,
           { desc = 'Restore session for current directory' })
    keymap('n', '<leader>pS', function() require('persistence').select() end,
           { desc = 'Select a session to load' })
    keymap('n', '<leader>pl', function() require('persistence').load { last = true } end,
           { desc = 'Load last session' })
    keymap('n', '<leader>pd', function() require('persistence').stop() end,
